...
function WeddingsPage() {
  ...
  const handleScroll = () => {
    ...
    if (h[st] > 50) {
      ...
      if (!element.classList.contains("active-progress"))
  ...
  return (
    <main>
      <Helmet>
        ...
        <script
          src="https://kit.fontawesome.com/b018042866.js"
          ...
          <div className="gallery">
            ...
            <div className="gallery-content">
              <SRLWrapper options={LightboxOptions}>
                <LandscapeRow images={couplePhotos[7]} />
                <PortraitRow images={couplePhotos[8]} />
                <PortraitRow images={couplePhotos[9]} />

                <LandscapeRow images={weddingPhotos[12]} />
                <PortraitRow images={weddingPhotos[13]} />
                <PortraitRow images={weddingPhotos[14]} />
                <PortraitRow images={weddingPhotos[15]} />
                <LandscapeRow images={weddingPhotos[16]} />
                <PortraitRow images={weddingPhotos[17]} />
                <LandscapeRow images={weddingPhotos[18]} />
                <PortraitRow images={weddingPhotos[19]} />
